...
import { AlertTriangle, Camera, CameraOff, Flag, Mic, MicOff, Radio, ShieldCheck, SkipForward, Square, Users, X } from "lucide-react";
import { Button } from "@/components/ui/button";

type Stage = "checking" | "blocked" | "consent" | "ready" | "queue" | "chat" | "stopped";
  ...
  useEffect(() => {
    fetch("/api/geo")
      ...
      .then(data => {
        ...
        setStage(data.allowed ? "consent" : "blocked");
